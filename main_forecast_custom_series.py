...
@author: Dr. Mike
Interactive Forecasting Interface: IFFA-TSCI-CNN

Provides an interactive menu-driven interface for time series forecasting
using the trained IFFA-TSCI-CNN model.
...
1. Menu System:
   ...
   - Enter time series manually
   - Exit program
   
2. Training:
   - Generates 30 synthetic ARIMA series
   - Finds optimal parameters
   - Trains CNN model
   - Validates performance
   - Reusable for multiple forecasts
   
3. Data Input Options:
   - CSV files: Loads first numeric column
   - Manual input: Space or comma-separated values
   - Synthetic: Generates for testing
   
4. Forecasting:
   - CNN predicts best ARIMA(p,d,q)
   - Generates 12-step ahead forecast
   - Shows confidence intervals
   - Reports statistical metrics
   
5. Error Handling:
   - Graceful handling of bad input
   - Automatic fallback ARIMA orders
...
3. For option 1: Trains model automatically
4. For options 2-3: Train if needed, then forecast
5. View results and continue or exit
